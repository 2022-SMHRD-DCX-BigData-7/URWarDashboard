...
<%}%>
  ...
  <!-- donation section -->
  	...
  	<div class="img-wrap">
		...
		<br><br>
		<h1 class="whitetext">
		아무리 시대가 최첨단의 시대를 달려가도 지상전은 여전히 존재하고,<br>
		전쟁의 피해는 고스란히 힘겨운 사람들의 몫으로 남습니다.<br>
		우크라이나 전쟁난민이 여기저기 있습니다. <br>
		<br> 
		</h1>
		<h1 class="whitetext1">앞으로 더욱 많은 사람들에게 다양한 생필품을 지원할 수 있도록 여러분의 도움을 부탁드립니다. </h1>
		</div>
	</div>
