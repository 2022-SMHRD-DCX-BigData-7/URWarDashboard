        ...
        <div class="row">
            <form method="post" action="writeAction.jsp"><!-- 데이터를 액션페이지로, 셀제로 글등록 -->
                <table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
                    <thead>
                        <tr><!-- 테이블의 행, 한줄 -->
                            <th colspan="2" style="background-color: #eeeeee; text-align: center;" width="2000">게시판 글쓰기</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr><!-- 테이블의 행, 한줄 -->
                            <td>
                                <input type="text" class="" placeholder="글 제목" name="BOARD_TITLE" maxlength="600">
                            </td>
                        </tr>
                        <tr><!-- 테이블의 행, 한줄 -->
                            <td><textarea class="" placeholder="글 내용" name="BOARD_CONTENT" maxlangth="4000" style="height: 350px;"></textarea>
                            </td>
                        </tr>
                    </tbody>
                </table>
