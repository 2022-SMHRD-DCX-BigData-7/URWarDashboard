...
<%
        ...
        WebBoard WebBoard = new  WebBoardDAO().getWebBoard(WB_SEQ);
            ...
            // 매개변수로서 글제목 내용을 넘겨서 빈공간 확인
                if (request.getParameter("WB_TITLE") == null || request.getParameter("WB_CONTENT") == null
                || request.getParameter("WB_TITLE").equals("") || request.getParameter("WB_CONTENT").equals("")) {
                    PrintWriter script = response.getWriter();
                    script.println("<script>");
                    ...
                    script.println("</script>");
                      ...
                      int result = WebBoardDAO.update(request.getParameter("WB_TITLE"), request.getParameter("WB_CONTENT"),WB_SEQ);
